<template>
  <div class="container">
    ...
    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
      ...
      <b-form-group id="input-group-firstname" labb-cols-sm="3" label="First name:" labb-for="firstname">
      ...
      <b-form-group id="input-group-lastname" labb-cols-sm="3" label="Last name:" labb-for="lastname">
      ...
      <b-form-group id="input-group-country" labb-cols-sm="3" label="Country:" labb-for="country">
      ...
      <b-form-group id="input-group-email" labb-cols-sm="3" label="Email:" labb-for="email">
      ...
      <b-form-group id="input-group-username" labb-cols-sm="3" label="Username:" labb-for="username">
      ...
      <b-form-group id="input-group-Password" labb-cols-sm="3" label="Password:" labb-for="password" >
      ...
      <b-form-group id="input-group-confirmedPassword" labb-cols-sm="3" label="Confirm Password:" labb-for="confirmedPassword" >
      ...
      <b-form-group id="input-group-image" labb-cols-sm="3" label="Image:" labb-for="image">
